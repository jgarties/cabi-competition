...
### Micromobility Data
Download CSV files from [Ride Report's DC Region page](https://public.ridereport.com/regions/washington). Save a separate CSV for each of the three regions and for each rideable type (e-bikes and scooters) for a total of six CSVs. Save them in another directory.
...
The new date columns will help us summarize by year, quarter, and month. We need quarter because the micromobility dataset is summarized by quarter.
...
Plot a stacked are chart similar to the chart for Capital Bikeshare, breaking down ridership by e-bikes and scooters.
...
*Takeaway:* Scooters dominate ridershp, but the proportion of e-bikes is growing.
...
Plot median trip duration across all Capital Bikeshare and micromobility rideables to assess whether riders select their service and rideable depending on the trip they are taking. We use Q3 2024 data because ridership peaks in Q3 every year, and 2024 is the most recent year avaialable. 
